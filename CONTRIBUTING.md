...
> [Documentation](https://github.com/NessMC/experiences/README.md).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/NessMC/experiences/issues) that might help you. In
...
-   Open an [Issue](https://github.com/NessMC/experiences/issues/new).
...
-   Determine if your bug is really a bug and not an error on your side e.g.
    ...
    read the [documentation](https://github.com/NessMC/experiences/README.md). If
...
-   To see if other users have experienced (and potentially already solved) the
    ...
    [bug tracker](https://github.com/NessMC/experiences/issues?q=label%3Abug).
...
-   Open an [Issue](https://github.com/NessMC/experiences/issues/new). (Since we
...
[Issue](https://github.com/NessMC/experiences/issues/new).
